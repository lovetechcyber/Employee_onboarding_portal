...
const Tabs = () => {
  ...
  return (
    <div>
      <ul className="mb-4 flex list-none flex-row flex-wrap border-b-0 pl-0" id="tabs-tab3" role="tablist">
      ...
      <div>
        <div
          className={`transition-opacity duration-150 ease-linear ${activeTab === 'personal' ? 'block' : 'hidden'}`}
          id="personal"
          role="tabpanel"
        ...
        >
          ...
          <div>
            ...
            <form>
              ...
              <input className="p-3 block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" type="file" />
        ...
        <div
          className={`transition-opacity duration-150 ease-linear ${activeTab === 'job' ? 'block' : 'hidden'}`}
          id="job"
          role="tabpanel"
        ...
        <div
          className={`transition-opacity duration-150 ease-linear ${activeTab === 'timeoff' ? 'block' : 'hidden'}`}
          id="timeoff"
          role="tabpanel"
        ...
        <div
          className={`transition-opacity duration-150 ease-linear ${activeTab === 'emergency' ? 'block' : 'hidden'}`}
          id="emergency"
          role="tabpanel"
          aria-labelledby="tabs-messages-tab3"
        >
        ...
        <div
          className={`transition-opacity duration-150 ease-linear ${activeTab === 'documents' ? 'block' : 'hidden'}`}
          id="documents"
          role="tabpanel"
          aria-labelledby="tabs-messages-tab3"
        >
        ...
        <div
          className={`transition-opacity duration-150 ease-linear ${activeTab === 'notes' ? 'block' : 'hidden'}`}
          id="notes"
          role="tabpanel"
          aria-labelledby="tabs-messages-tab3"
        >
        ...
        <div
          className={`transition-opacity duration-150 ease-linear ${activeTab === 'tasks' ? 'block' : 'hidden'}`}
          id="tasks"
          role="tabpanel"
          aria-labelledby="tabs-messages-tab3"
        >
